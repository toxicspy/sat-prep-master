...
const About = () => (
  <Layout>
    <div className="container max-w-3xl py-10">
      <h1 className="text-3xl font-bold mb-6">About SAT Ace Prep</h1>
      <div className="space-y-4 text-muted-foreground leading-relaxed">
        <p>
          SAT Ace Prep is a free, student-focused platform designed to help high school students prepare for the SAT with confidence. We provide original, SAT-aligned practice questions with detailed explanations.
        </p>
        <p>
